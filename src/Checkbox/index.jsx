...
const Checkbox = ({onChange, value, label}) => {
  ...
  return (
    ...
    <StyledCheckbox type="button" onClick={handleEvent(onChange, setChecked, value, checked)}>

{checked ? <FontAwesomeIcon icon={faCheck} style={{color: 'var(--aiwizo-application-green)'}}/> : null}
